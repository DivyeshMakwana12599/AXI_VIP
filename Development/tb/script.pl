...
=======
>>>>>>> 34104fed84722bef1811afddd33b2a60d07fdf84
...
<<<<<<< HEAD
system("vcs -sverilog -full64 -debug_access+r  +error+20 ei_axi4_top.sv && ./simv +ei_axi4_SANITY_TEST +total_num_trans=4 +length=3 +size=2 +addr_type=0");
...
#system("vcs -sverilog -full64 -debug_access+r ei_axi4_top.sv && ./simv -gui  +ei_axi4_PARALLEL_WR_RD_TEST +total_num_trans=4 +length=3");
>>>>>>> 34104fed84722bef1811afddd33b2a60d07fdf84
